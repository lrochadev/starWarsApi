...
@Configuration
@EnableConfigurationProperties({RetryMessageProperties.class, CircuitBreakerProperties.class})
public class ApplicationConfiguration {

    @Bean
    public CircuitBreaker swapiCircuitBreaker(final CircuitBreakerProperties cbProps) {
    ...
    @Bean
    public RestClient restClient(final RetryMessageProperties properties) throws NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
    ...
    private ClientHttpRequestFactory clientHttpRequestFactory(final RetryMessageProperties properties) throws NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
